...
public class SurveyId implements Serializable{	// SurveyItem 복합키 클래스
	...
	private Long surveyId;	// 설문조사 아이디
	private int surveySn;	// 설문조사 순번(이력)
    ...
    public boolean equals(Object o) {
        ...
        return surveySn == that.surveySn &&
                Objects.equals(surveyId, that.surveyId);
    }

    @Override
    public int hashCode() {
        return Objects.hash(surveyId, surveySn);
    }
