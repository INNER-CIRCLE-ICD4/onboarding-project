...
enum class ErrorCode(
    ...
    SURVEY_NAME_DUPLICATED(BAD_REQUEST, "이미 등록된 설문조사 이름입니다."),
    ...
    SURVEY_ITEMS_INVALID(BAD_REQUEST, "설문 항목은 1개 이상 10개 이하여야 합니다."),
    ...
    OPTION_NAME_REQUIRED(BAD_REQUEST, "항목 옵션 이름은 필수입니다."),
    OPTION_NAME_TOO_LONG(BAD_REQUEST, "항목 옵션 이름은 200자를 초과할 수 없습니다."),
    SELECT_OPTIONS_REQUIRED(BAD_REQUEST, "선택형 문항에는 선택지가 필요합니다."),
    INVALID_ITEM_TYPE(BAD_REQUEST, "유효하지 않은 설문 항목 타입입니다."),
    INVALID_OPTION_NAME(BAD_REQUEST, "유효하지 않은 옵션 이름입니다."),
    REQUIRED_RESPONSE_MISSING(BAD_REQUEST, "필수 항목이 누락되었습니다."),
    RESPONSE_DUPLICATED(BAD_REQUEST, "응답 항목이 중복되었습니다."),
