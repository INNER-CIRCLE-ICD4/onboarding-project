...
public class CreateSurveyRequest {
    ...
    @Schema(description = "생성자 식별자", example = "admin@company.com")
     ...
     * 생성자
     */
    public CreateSurveyRequest(String title, String description, List<CreateQuestionRequest> questions, String createdBy) {
        this.title = title;
