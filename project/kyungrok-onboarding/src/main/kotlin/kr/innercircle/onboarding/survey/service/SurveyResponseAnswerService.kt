...
class SurveyResponseAnswerService(
    ...
    fun createSurveyResponseAnswers(
        ...
        val surveyResponseAnswers = createSurveyResponseAnswerRequests.map {
            val surveyItem = surveyItemService.getSurveyItemById(it.surveyItemId)
            SurveyResponseAnswer.from(surveyItem, surveyResponse, it)
        }
