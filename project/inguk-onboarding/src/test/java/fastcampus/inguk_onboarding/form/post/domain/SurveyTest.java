...
class SurveyTest {
    ...
    void createSurvey_실패_항목11개() {
        // given - 11개 항목 생성
        List<Content> contents = List.of(
                new Content("항목1", "설명1", InputType.SHORT_TYPE, true, 1, null),
                new Content("항목2", "설명2", InputType.SHORT_TYPE, true, 2, null),
                new Content("항목3", "설명3", InputType.SHORT_TYPE, true, 3, null),
                new Content("항목4", "설명4", InputType.SHORT_TYPE, true, 4, null),
                new Content("항목5", "설명5", InputType.SHORT_TYPE, true, 5, null),
                new Content("항목6", "설명6", InputType.SHORT_TYPE, true, 6, null),
                new Content("항목7", "설명7", InputType.SHORT_TYPE, true, 7, null),
                new Content("항목8", "설명8", InputType.SHORT_TYPE, true, 8, null),
                new Content("항목9", "설명9", InputType.SHORT_TYPE, true, 9, null),
                new Content("항목10", "설명10", InputType.SHORT_TYPE, true, 10, null),
                new Content("항목11", "설명11", InputType.SHORT_TYPE, true, 11, null)
        );
    ...
    void createSurvey_정상_다중선택형포함() {
        // given
        List<Content> contents = List.of(
                new Content("취미", "관심있는 취미를 모두 선택해주세요", InputType.MULTIPLE_TYPE, false, 1,
    ...
    void createSurvey_정상_장문형포함() {
        // given
        List<Content> contents = List.of(
                new Content("의견", "개선사항이나 의견을 자유롭게 작성해주세요", InputType.LONG_TYPE, false, 1, null)
        );
