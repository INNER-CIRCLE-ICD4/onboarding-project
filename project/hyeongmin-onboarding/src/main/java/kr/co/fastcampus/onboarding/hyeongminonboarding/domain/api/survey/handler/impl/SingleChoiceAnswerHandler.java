...
@Component
public class SingleChoiceAnswerHandler implements AnswerHandler {
    ...
    @Override
    public void validate(SubmitAnswerRequest answer, Question question, List<QuestionOption> options) {
        ...
        if (selected != null && selected.size() > 1) {
            throw new IllegalArgumentException("단일 선택 질문에는 하나의 옵션만 선택해야 합니다: " + question.getTitle());
        }
